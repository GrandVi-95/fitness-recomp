// ─── Server-only nutrition utilities ─────────────────────────────────────────
// This file imports `db` (Prisma) and must NEVER be imported by Client Components.
// Server Components, API routes, and server-side libraries import from here.
